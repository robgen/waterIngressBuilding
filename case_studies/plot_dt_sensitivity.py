...
Produces:
  case_studies/ex01/out/dt_sensitivity.png
"""
import math
import os
import sys
...
# ── shared rcParams (mirrors viz.py / plot_mc.py) ─────────────────────────────
plt.rcParams.update({
...
# Shared triangular hydrograph matching run_cases.py (flood 0-60 min, dry tail to 120 min)
