...
Produces:
  case_studies/ex05/out/dt_sensitivity.png
"""
import copy
import math
import os
...
from main import Building, IngressPathway, Simulation, sample_with_zero_padding
from pump import SumpPump

# ── shared rcParams (mirrors viz.py / plot_dt_sensitivity.py) ─────────────────
plt.rcParams.update({
...
# ── Case 05 parameters (must match run_cases.py) ──────────────────────────────
FLOOR_AREA           = 50.0
BASEMENT_AREA        = 30.0
...
# dry tail to 360 min — same as run_cases.py)
